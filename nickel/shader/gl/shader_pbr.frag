...
layout(binding = 6) uniform sampler2D baseColorSampler;
layout(binding = 7) uniform sampler2D normalMapSampler;
layout(binding = 8) uniform sampler2D metalroughnessSampler;
layout(binding = 9) uniform sampler2D occlusionSampler;
...
void main() {		
    ...
    vec3 metalRoughness = texture(metalroughnessSampler, fs_in.fragUV).rgb;
