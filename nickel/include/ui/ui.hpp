...
void InitSystem(gecs::commands, gecs::resource<Window>);

void ShutdownSystem(gecs::commands);

void RenderUI(gecs::querier<Style, gecs::without<Parent>>,
              gecs::resource<gecs::mut<Camera>>, gecs::registry);
...
void HandleEventSystem(gecs::querier<Style, gecs::without<Parent>>,
